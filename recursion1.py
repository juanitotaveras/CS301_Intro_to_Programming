...
def stringClean(str):
  if len(str) < 1:
    ...
    if len(str) > 2 and str[0] == str[1] and str[1] == str[2]:
      return str[0] + stringClean(str[3:])
    elif str[0] == str[1]:
      return str[0] + stringClean(str[2:])
    else:
...
def nestParen(str):
  if len(str) == 1:
    ...
    elif str[0] == "(" and str[1] == ")" and len(str) == 2:
      return True
    else:
      return False
...
def strDist(str, sub):
  if len(str) == 0:
    ...
    if str[:len(sub)] == sub and str[-len(sub):] == sub:
      return len(str)
    elif str[:len(sub)] == sub and str[-len(sub):] != sub:
